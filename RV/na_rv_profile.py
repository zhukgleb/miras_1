...
with plt.style.context(["science"]):
    ...
    if other:
        ...
        ax.scatter(spectra_date, na_A_velocity, label="Velocity Na component A")
        ax.scatter(spectra_date, na_B_velocity, label="Velocity Na component B")
        ax.scatter(spectra_date, rv_combo_arr, label="ZrO velocity")
        ax.legend()
