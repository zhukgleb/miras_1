...
tio_spectrum_path = "/home/delta/exocross/input/ZrO_Mira_2000K_Voigt_na_emiss.xsec"
...
_, nu_tio = pyasl.dopplerShift(nu_tio, sigma_tio, -16, edgeHandling="firstlast")
...
F_transmitted = F_star_interp * (1.0 + np.exp(-tau))
