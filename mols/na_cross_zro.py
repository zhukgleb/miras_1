...
tio_spectrum_path = "/home/delta/exocross/input/ZrO_Mira_2000K_Voigt_na.xsec"
...
_, nu_tio = pyasl.dopplerShift(nu_tio, sigma_tio, 0, edgeHandling="firstlast")
...
N_TiO = 2e17  # Пример для холодного гиганта, измените под свою задачу
...
plt.plot(
    nu_tio, F_transmitted, "g-", linewidth=0.8, label="Спектр после поглощения ZrO"
)
